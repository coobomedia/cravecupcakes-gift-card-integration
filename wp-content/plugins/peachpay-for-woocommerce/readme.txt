=== PeachPay Checkout and Payments for WooCommerce: Stripe, PayPal, Square ===
...
PeachPay is supercharging WooCommerce checkout and payments. Connect and manage all your payment methods, offer shoppers a beautiful Express Checkout, and track cart abandonment analytics, all from one place.

== Description ==

Forget multiple plugins — manage your checkout and payments from one place. Connect 20+ payment methods from Stripe, PayPal, Square, Authorize.net, Amazon Pay and more.

With PeachPay Premium, increase your reach to global shoppers using the **currency switcher**. Customize your checkout with the **field editor**. Let shoppers check out from anywhere with **Express Checkout**. Automatically **recommend products** by category to increase average order value. See how your payments are doing and get **insights about abandoned carts**. It's everything you need, together.

Read below to see how PeachPay is the all-in-one enhancement to any WooCommerce store.

https://www.youtube.com/watch?v=cwNdbCaskSs

= Payment methods =

Connect and manage all your payments in one place.

- **All payment providers in one plugin** — Connect your Stripe, Square, PayPal, Authorize.net, or Amazon Pay account in seconds
- **Offer shoppers alternate payment methods** — credit/debit cards, Apple and Google Pay, Affirm, Klarna, Afterpay (Clearpay), US bank account ACH, Bancontact, Giropay, iDEAL, Sofort, Przelewy24, EPS, PayPal Pay in 3, PayPal Pay in 4, Venmo, Cash App
- **Do you sell expensive items and pay high fees?** — Configure minimum and maximum cart amounts for when certain payment methods should show
- **Want to restrict payment methods to certain countries and currencies?** — You're in full control if you want. Don't care? We have it taken care of with sensible defaults
- Add **custom fees** per payment method
...
- Full support for **3D Secure** and Strong Customer Authentication (SCA)
- Automatic refunds upon order cancellation
- For Stripe, if a payment is disputed, PeachPay can automatically mark order status as cancelled
- Choose between Capture and Authorize charge type for Stripe card payments

**With [PeachPay Premium](https://peachpay.app/get-peachpay?utm_campaign=listing&utm_source=wordpress.org), you get the following upgrades**:
...
- Field types include text, select (drop down), radio, phone, email, checkbox
...
Understand how your shoppers purchase and pay so that you can get more sales on your store.
...
- Export orders to CSV (find it in the WooCommerce order dashboard under "Bulk actions")
...
- Adds an Express Checkout button to all product pages, cart page, mini/sidebar cart, and checkout page
...
- Choose your button color, width, alignment, border radius, visibility by page, and more
- Modify every part of the Express Checkout window, including fields, coupons/discount codes, product recommendations, order notes visibility, and more
- Fully compatible with our field editor
...
- Returning shoppers have **one-click checkout**
- Shoppers with prior PeachPay purchases on other stores can purchase from your store with one click
...
- Google Maps auto complete for billing and shipping fields
...
There is no additional charge for using our payment methods. We take a cut of the transaction fee from the payment processor, and you pay nothing extra. You keep your existing rates.

For PeachPay Premium, which gets you the currency switcher, express checkout, field editor, and other upgrades, we offer [transparent pricing on our website](https://peachpay.app/get-peachpay?utm_campaign=listing&utm_source=wordpress.org).
...
1. Choose from over 22 payment methods: Stripe, PayPal, Square, Amazon Pay, Authorize.net—and we're always adding more!
