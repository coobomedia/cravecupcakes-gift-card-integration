...
class Peachpay_Currency_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Peachpay Currency Switcher', 'Peachpay' ),
	...
	public function form( $instance ) {
		if ( isset( $instance['title'] ) ) {
			...
			$title = __( 'New title', 'peachpay_for_woocommerce' );
		}
		...
		?>
		<p>
		<label for="<?php esc_html( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'peachpay_for_woocommerce' ); ?></label>
		<input class="widefat" id="<?php echo esc_html( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_html( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		<label for="read_only"> <?php esc_html_e( 'Read only:', 'peachpay_for_woocommerce' ); ?></label>
