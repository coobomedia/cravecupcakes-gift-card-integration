...
= 6.6.4 =
* Added: Filter hook 'woosb_sold_individually_found_in_cart'
* Added: HPOS compatibility

= 6.6.3 =
* Fixed: Rounding the price and total

= 6.6.2 =
* Added: Filter hook 'woosb_image_size'
...
= 6.5.3 =
* Fixed: 'On backorder' status

= 6.5.2 =
* Fixed: Calculate min price from bundled products' min quantity

= 6.5.1 =
* Added: Filter hook 'woosb_price_trim_zeros'
